#pragma checksum "C:\Users\MONSTER\source\repos\camasirhaneekipmanlari\Web\Web\Views\Home\Sitemap.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5460a1338bffd71f86d92ab8c3f2d85abf03fd79"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5460a1338bffd71f86d92ab8c3f2d85abf03fd79", @"/Views/Home/Sitemap.cshtml")]
...
#nullable disable
            WriteLiteral("\n\n\n<div >\n ");
#nullable restore
#line 20 "C:\Users\MONSTER\source\repos\camasirhaneekipmanlari\Web\Web\Views\Home\Sitemap.cshtml"
...
#nullable disable
					...
					<div class=""row"">
						<div class=""col-sm-3"">
							...
							<ul class=""list list-icons list-icons-sm mb-4"">
								...
								<li>
									<h4 class=""font-weight-bold text-3 mb-1 mt-2"">Classic</h4>
            ...
            WriteLiteral(@"text-3 mb-1 mt-2"">Corporate</h4>
									<ul class=""list list-icons list-icons-sm mb-3 text-2"">
										...
										<li><a href=""index-corporate-9.html""><i class=""far fa-file""></i>Corporate - Ver");
            WriteLiteral(@"sion 9</a></li>
								...
								<li>
									<h4 class=""font-weight-bold text-3 mb-1 mt-2"">One Page</h4>
									<ul class=""list list-icons list-icons-sm mb-3 text-2"">
						...
						<div class=""col-sm-3"">
							...
							<ul class=""list list-icons list-icons-sm mb-");
            WriteLiteral(@"4"">
								<li>
									<h4 class=""font-weight-bold text-3 mb-1 mt-2"">Elements 1</h4>
									<ul class=""list list-icons list-icons-sm mb-3 text-2"">
								...
								<li>
									<h4 class=""font-weight-bold text-3 mb-1 mt-2"">Elements 2</h4>
									<ul class=""list list");
            WriteLiteral(@"-icons list-icons-sm mb-3 text-2"">
								...
								<li>
									<h4 class=""font-weight-bold text-3 mb-1 mt-2"">Elements 3</h4>
									<ul class=""list list-icons list-icons-sm mb-3 text-2"">
										<li><a href=""elements-call-to-action.h");
            WriteLiteral(@"tml""><i class=""far fa-file""></i>Call to Action</a></li>
								...
								<li>
									<h4 class=""font-weight-bold text-3 mb-1 mt-2"">Elements 4</h4>
									<ul class=""list list-icons list-icons-sm mb-3 text-2"">
										<li><a href=""elements-headings.html""><i class=""far fa-file""></i>Headings</a></li>
");
            WriteLiteral(@"										<li><a href=""elements-dividers.html""><i class=""far fa-file""></i>Dividers</a></li>
						...
						<div class=""col-sm-3"">
							...
							<ul class=""list list-icons list-icons-sm mb-4"">
								<li>
									<h4 class=""font-weight-bold text-3 mb-1 mt-2"">Contact Us</h4>
									<ul class=""list list-icons list-icons-sm mb-3 text-2"">
										<li><a href=""contact-us-advanced.php""><i cl");
            WriteLiteral(@"ass=""far fa-file""></i>Contact Us - Advanced</a></li>
								...
								<li>
									<h4 class=""font-weight-bold text-3 mb-1 mt-2"">About Us</h4>
									<ul class=""list list-icons list-icons-sm mb-3 text-2"">
								...
								<li>
									<h4 class=""font-weight-bold text-3 mb-1 mt-2"">Layouts</h4>
									<ul class=""list list-icons list-icons-sm mb-3 text-2"">
										<li><a href=""page-full-width.html""><i class=""far fa-file""></i>Full Width</a></li>
										<li><a href=""page-left-sidebar.html""><i");
            WriteLiteral(@" class=""far fa-file""></i>Left Sidebar</a></li>
								...
								<li>
									<h4 class=""font-weight-bold text-3 mb-1 mt-2"">Extra</h4>
									<ul class=""list list-icons list-icons-sm mb-3 text-2"">
            ...
            WriteLiteral(@"	</li>
								<li>
									<h4 class=""font-weight-bold text-3 mb-1 mt-2"">Team</h4>
									<ul class=""list list-icons list-icons-sm mb-3 text-2"">
								...
								<li>
									<h4 class=""font-weight-bold text-3 mb-1 mt-2"">Services</h4>
									<ul class=""list list-icons list-icons-sm mb-3 text-2"">
								...
								<li><a href=""page-custom-header.html""><i class=""far fa-file""></i>Custom Header</a></li>
            ...
            WriteLiteral(@"
						...
						<div class=""col-sm-3"">
							...
							<ul class=""list list-icons list-icons-sm mb-4"">
								<li>
									<h4 class=""font-weight-bold text-3 mb-1 mt-2"">Single Project</h4>
									<ul class=""list list-icons list-icons-sm mb-3 text-2"">
										<li><a href=""portfolio-single-wide-slider.html""><i class=""far fa-file""></i>Small Slider</a></li>
										<li><a href=""portfolio-single-wide-slider.html""><i class=""far fa-file""></i>Wide Slider</a></li>
										...
										<");
            WriteLiteral(@"li><a href=""portfolio-single-carousel.html""><i class=""far fa-file""></i>Carousel</a></li>
								...
								<li>
									");
            WriteLiteral(@"<h4 class=""font-weight-bold text-3 mb-1 mt-2"">Grid Layouts</h4>
									<ul class=""list list-icons list-icons-sm mb-3 text-2"">
										...
										<li><a href=""portfolio-grid-full-width-no-margins.html""><i class=""far fa-file""></i>F");
            WriteLiteral(@"ull Width No Margins</a></li>
										<li><a href=""portfolio-grid-1-column-title-and-description.html""><i class=""far fa-file""></i>Title and Description</a></li>
									</ul>
								</li>
								<li>
									<h4 class=""font-weight-bold text-3 mb-1 mt-2"">Masonry Layouts</h4>
									<ul class=""list list-icons list-icons-sm mb-3 text-2"">
										...
										<li><a href=""portfolio-masonry-full-width.html""><");
            WriteLiteral(@"i class=""far fa-file""></i>Full Width</a></li>
									</ul>
								</li>
								<li>
									<h4 class=""font-weight-bold text-3 mb-1 mt-2"">Sidebar Layouts</h4>
									<ul class=""list list-icons list-icons-sm mb-3 text-2"">
								...
								<li>
									<h4 class=""font-weight-bold text-3 mb-1 mt-2"">Ajax</h4>
									<ul class=""list list-icons list-icons-sm mb-3 text-2"">
										<li><a href=""portfolio-ajax-page.html""><i class=""far fa-file""></i>Ajax on Page</a></li>
										<li><a href=""portfolio-ajax-modal.html""><i class=""far fa-file""></i>Ajax on Modal</a></");
            WriteLiteral(@"li>
									</ul>
								</li>
								<li>
